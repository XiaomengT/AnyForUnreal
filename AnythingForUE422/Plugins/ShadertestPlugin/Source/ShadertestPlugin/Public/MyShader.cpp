...
UShaderBlueprintLibrary::UShaderBlueprintLibrary(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
class FShaderTestVS : public FMyShader
{
...
class FShaderTestPS : public FMyShader
{
...
void UShaderBlueprintLibrary::DrawTestShaderRenderTarget(
